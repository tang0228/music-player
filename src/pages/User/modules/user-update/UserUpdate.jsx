...
import { updateUserInfo } from "../../../../services/apis";
    ...
    <div className="user-update-container">
      ...
      <div className="update-wrap">
        ...
        <div className="row">
          ...
          <TextArea value={intro} maxCount={300} showCounter onChange={textChange}></TextArea>
        </div>
        <div className="row">
        ...
        <div className="row">
          ...
          <DatePicker value={birth} onChange={dateChange}></DatePicker>
        </div>
